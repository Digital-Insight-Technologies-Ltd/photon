...
public class ConvertToJson {
    private final static String[] KEYS_LANG_UNSPEC = {Constants.OSM_ID, Constants.OSM_VALUE, Constants.OSM_KEY, Constants.POSTCODE, Constants.HOUSENUMBER, Constants.COUNTRYCODE, Constants.OSM_TYPE, Constants.OSM_PARENT_ID, Constants.EXTRA_FIELDS};
    ...
    public List<JSONObject> convert(SearchResponse searchResponse) {
        ...
        for (SearchHit hit : hits) {
            ...
            final JSONObject feature = new JSONObject();
            feature.put(Constants.PLACE_ID, hit.docId());
            feature.put(Constants.TYPE, Constants.FEATURE);
            feature.put(Constants.GEOMETRY, getPoint(source));
